...
function ChestFilm({ active, preset }: { active: number; preset: Preset }) {
            ...
            <div className="flex items-center justify-between gap-4 border-b border-hairline bg-sidebar px-4 py-2">
              ...
              <label className="hidden h-8 w-52 items-center gap-2 rounded-lg border border-hairline bg-card px-2.5 text-xs text-muted-foreground shadow-sm md:flex xl:w-64">
                ...
                <span className="flex-1 truncate">
                  Search patients, studies, orders…
                </span>
                <kbd className="rounded border border-hairline px-1 font-mono text-[8px] text-muted-foreground">
                  ⌘K
                </kbd>
              </label>
              ...
              <div className="grid flex-1 grid-cols-1 gap-px bg-hairline lg:h-[560px] lg:grid-cols-[220px_minmax(0,1fr)_300px] xl:h-[620px] xl:grid-cols-[248px_minmax(0,1fr)_336px]">
                ...
                >
                      ...
                      >
                        ...
                        <dd
                          className={cn(
                            "font-mono text-xs",
                            v.warn
                              ? "font-medium text-[color:var(--vital)]"
                              : "text-ink",
                          )}
                        >
                          {v.v}
                  ...
                  <p className="mt-2 font-mono text-xs text-ink">
                    WBC{" "}
                    <span className="text-[color:var(--vital)]">14.2 ▲</span> ·
                    CRP <span className="text-[color:var(--vital)]">96 ▲</span>
                  </p>
                  <p className="mt-1 font-mono text-xs text-muted-foreground">
                    GLUC{" "}
                    <span className="text-[color:var(--vital)]">11.4 ▲</span> ·
                    eGFR <span className="text-ink">68</span> · LACT 1.2
                  </p>
                ...
                >
                  <div className="flex flex-wrap items-center justify-between gap-3">
                    ...
                    >
                      <TabsList
                        variant="line"
                        className="h-7 flex justify-content center"
                      >
                  ...
                  >
                    {findings.map((f) => (
                      ...
                      >
                        <f.icon
                          className={cn("mt-0.5 size-4 shrink-0", f.tone)}
                          aria-hidden
                        />
                ...
                >
                  ...
                  <Card id="summary" className="rounded-none xl:rounded-none">
                    <CardHeader className="pb-2 pt-4">
                      <CardTitle className="flex items-center gap-1.5 text-sm">
                        <Sparkles
                          className="size-3.5 text-[color:var(--signal)]"
                          aria-hidden
                        />
                        AI summary
                      </CardTitle>
                  ...
                  <Card
                    id="extraction"
                    className="rounded-none xl:rounded-none"
                  >
                    <CardHeader className="pb-2 pt-4">
                      <CardTitle className="flex items-center gap-1.5 text-sm">
                        <FileText
